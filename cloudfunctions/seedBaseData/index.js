...
const VIP_PLANS = [
  { code: 'basic_vip_year', tag: '基础VIP', name: '基础VIP包年', price: 19800, days: 365, supervisionDays: 30, virtualProductId: 'sz_basic_vip_year', sort: 1, enabled: true, benefits: ['免广告学习', '督学包月服务（30天）'] },
