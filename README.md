...
| 最新已上传开发版本 | `1.0.37`（待核验微信公众平台审核、发布状态） |
...
2026-09-13 已完成本轮客户 12 项反馈的回归验收，包含正式云端读写、开发者工具页面交互和图片生成。本轮追加修复只涉及云函数，不改变已上传的客户端包；正式客户端是否发布仍以微信公众平台为准。测试范围、结果与未覆盖项见 [9 月 13 日修复与验收记录](docs/verification-2026-09-13.md)。
